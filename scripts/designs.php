...
$CATEGORIES = [
    ...
    [
        ...
        'ready' => true,
        'keywords' => 'free website templates, saas landing page template, pricing table html, portfolio template, docs template, dashboard template',
        'title' => 'Free Business Website Templates: Landing, Pricing, Shop',
        'desc' => '10 free business page templates. SaaS landing, pricing table, portfolio, docs site, shop grid, analytics dashboard, blog, link in bio, waitlist, directory.',
        'intro' => 'These are the pages people actually need to launch a business online. Each one is a complete, working page: the pricing toggle switches, the shop filters and sorts, the dashboard redraws its charts, the docs copy code, the waitlist counts down and the directory searches as you type. Download one, change the words and it is ready to go live.',
    ],
];
...
.mini { box-shadow: 4px 4px 0 #e9e2d2, 8px 8px 0 #d8cfbb; }',
    ...
    [
        'num' => 91, 'cat' => '10-business-ready', 'slug' => '091-saas-landing', 'name' => 'SaaS Landing Page',
        'example' => 'Formly, a form builder',
        'title' => 'Free SaaS Landing Page Template in HTML and CSS',
        'desc' => 'Free SaaS landing page template for a form builder. Hero with product preview, logo row, features, testimonial, FAQ and email sign up. Live demo.',
        'keywords' => 'saas landing page template, free landing page html, startup website template, software landing page, product landing page css',
        'what' => [
        ...
        'when' => ['Software and app launches', 'Startup homepages', 'Online tools and services', 'Side projects that need a home page'],
        'features' => ['Hero with a clear headline and two buttons', 'Product preview built in HTML', 'Logo row for social proof', 'Feature grid, testimonial and FAQ', 'Email sign up with confirmation'],
        ...
        'faq' => [
            ['What should a SaaS landing page include?', 'A clear headline, a short description, a main call to action, a product preview, social proof, key features, an FAQ and a final sign up.'],
            ['Can I use this with Webflow or WordPress?', 'Yes. Copy the HTML and CSS into a custom code block, or use it as a guide for your layout.'],
            ['How do I connect the sign up form?', 'Set the form action to your email tool or backend, such as Mailchimp, ConvertKit or your own API.'],
        ],
    ],
    [
        'num' => 92, 'cat' => '10-business-ready', 'slug' => '092-pricing-table', 'name' => 'Pricing Table',
        'example' => 'Notecraft, a notes app',
        'title' => 'Free Pricing Table Template with Monthly and Yearly Toggle',
        'desc' => 'Free pricing table template with a working monthly and yearly toggle, three plans, a featured tier and a full feature comparison table. Live demo.',
        'keywords' => 'pricing table html css, pricing page template, monthly yearly toggle, saas pricing template, pricing comparison table',
        'what' => [
        ...
        'when' => ['SaaS and app pricing pages', 'Memberships and subscriptions', 'Agency service packages', 'Course and coaching plans'],
        'features' => ['Monthly and yearly toggle that updates every price', 'Featured plan with a badge and colored border', 'Tick lists drawn in CSS', 'Full comparison table with accessible headers', 'Table scrolls on phones'],
        'css' => ".p.f { border: 2px solid #0e7c66; position: relative; }\n.p.f::before {\n  content: \"Most popular\";\n  position: absolute; top: -13px; left: 24px;\n  background: #0e7c66; color: #fff; border-radius: 999px; padding: 3px 10px;\n}\n.p li::before { width: 10px; height: 6px; border-left: 2px solid #0e7c66; border-bottom: 2px solid #0e7c66; transform: rotate(-45deg); }",
        'faq' => [
            ['How does the monthly and yearly toggle work?', 'Each price has data-m and data-y attributes. A few lines of JavaScript swap the text when you click a toggle button.'],
            ['How many plans should a pricing page have?', 'Three is the most common and easiest to compare. Highlight the one most people should choose.'],
            ['Is the comparison table accessible?', 'Yes. It uses a real table with header cells, so screen readers can read each row and column.'],
        ],
    ],
    [
        'num' => 93, 'cat' => '10-business-ready', 'slug' => '093-portfolio', 'name' => 'Minimal Portfolio',
        'example' => 'Ana Ribeiro, a product designer',
        'title' => 'Free Minimal Portfolio Website Template for Designers',
        'desc' => 'Free minimal portfolio template for a product designer. Short intro, availability status, case study cards, experience list and contact line. Live demo.',
        'keywords' => 'minimal portfolio template, designer portfolio html, personal website template, ux portfolio template, simple portfolio css',
        'what' => [
        ...
        'when' => ['Product and UX designers', 'Developers and writers', 'Freelancers of any kind', 'Job applications and personal sites'],
        'features' => ['Serif intro line with one soft accent', 'Green availability dot', 'Case study cards with year and one line result', 'Experience list with dates and places', 'Large contact line with email link'],
        'css' => ".w { max-width: 860px; margin: 0 auto; padding: 0 24px; }\nh1 { font-family: Newsreader, serif; font-size: clamp(2rem, 5vw, 3.2rem); max-width: 22ch; }\n.cs .img { aspect-ratio: 16 / 9; border-radius: 12px; transition: transform .35s; }\n.cs:hover .img { transform: scale(.985); }\n.row { display: grid; grid-template-columns: 140px 1fr auto; border-top: 1px solid #e5e4de; }",
        'faq' => [
            ['What should a designer portfolio include?', 'A clear line about what you do, three to five strong case studies with results, a short work history and an easy way to contact you.'],
            ['How many projects should I show?', 'Three to five of your best. Quality matters far more than quantity.'],
            ['Can I host this portfolio for free?', 'Yes. GitHub Pages, Netlify and Cloudflare Pages all host a single HTML file for free.'],
        ],
    ],
    [
        'num' => 94, 'cat' => '10-business-ready', 'slug' => '094-docs-site', 'name' => 'Docs Site',
        'example' => 'Quarry, an API documentation site',
        'title' => 'Free Documentation Website Template for APIs (HTML)',
        'desc' => 'Free documentation site template for an API. Sidebar filter, code blocks with copy buttons, callouts, an options table and an on this page menu. Live demo.',
        'keywords' => 'documentation website template, docs site html, api documentation template, developer docs css, sidebar docs layout',
        'what' => [
        ...
        'when' => ['API and developer docs', 'Product help centers', 'Open source project docs', 'Internal team wikis'],
        'features' => ['Three column layout with sticky sidebars', 'Sidebar filter that hides pages as you type', 'Code blocks with language label and copy button', 'Tip callout and options table', 'Previous and next page links'],
        'css' => ".layout { display: grid; grid-template-columns: 250px minmax(0, 1fr) 200px; }\naside.nav { position: sticky; top: 53px; height: calc(100vh - 53px); overflow-y: auto; }\n.cb pre { background: #0f1420; color: #e6e9f0; border-radius: 10px; padding: 32px 16px 16px; overflow-x: auto; }\n.cb pre code { background: none; padding: 0; }\n.note { background: #eef6ff; border-left: 4px solid #0b6bcb; }",
        'faq' => [
            ['Why use minmax(0, 1fr) for the content column?', 'It stops long code lines from stretching the column. The code block scrolls sideways instead.'],
            ['How do I add syntax highlighting?', 'Wrap keywords and strings in spans with classes, as in the example, or add a library like Prism or Shiki for automatic highlighting.'],
            ['Can this handle many pages?', 'Yes. Copy the file for each page, or use it as the layout in a static site generator like Eleventy or Astro.'],
        ],
    ],
    [
        'num' => 95, 'cat' => '10-business-ready', 'slug' => '095-shop-grid', 'name' => 'Shop Product Grid',
        'example' => 'Loop and Knot, a knitwear shop',
        'title' => 'Free E-commerce Product Grid Template with Filters (HTML)',
        'desc' => 'Free e-commerce product grid template for a knitwear shop. Working category filters, sort by price, color swatches, badges and a basket counter. Live demo.',
        'keywords' => 'ecommerce product grid html, shop template free, product listing page, product filter javascript, online store template',
        'what' => [
        ...
        'when' => ['Clothing and fashion shops', 'Handmade and craft stores', 'Product catalogs', 'Shopify or WooCommerce theme mockups'],
        'features' => ['Category filter chips that work', 'Sort by newest or price', 'Color swatches and New or Bestseller badges', 'Basket counter that bumps on add', 'Four, three or two columns by screen size'],
        'css' => ".grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px; }\n@media (max-width: 960px) { .grid { grid-template-columns: repeat(3, 1fr); } }\n@media (max-width: 700px) { .grid { grid-template-columns: 1fr 1fr; } }\n.pr .ph { aspect-ratio: 4 / 5; background: var(--c); }\n.chips button[aria-pressed=\"true\"] { background: #1f1b16; color: #fff; }",
        'faq' => [
            ['How do I add my own products?', 'Edit the list at the top of the script. Each product has a name, category, price, color and optional badge.'],
            ['Can I connect this to a real shop?', 'Yes. Replace the list with data from your shop API, and point Add to basket at your cart system, like Shopify Buy Button or Snipcart.'],
            ['Is the product grid good for SEO?', 'For real shops, render the products in the HTML on the server so Google sees them. The layout and CSS stay the same.'],
        ],
    ],
    [
        'num' => 96, 'cat' => '10-business-ready', 'slug' => '096-analytics-dashboard', 'name' => 'Analytics Dashboard',
        'example' => 'Tally, a web analytics tool',
        'title' => 'Free Analytics Dashboard Template with SVG Charts (HTML)',
        'desc' => 'Free analytics dashboard template. KPI cards, an SVG line chart with a date range switch, a donut chart and a top pages table with bars. Live demo.',
        'keywords' => 'analytics dashboard template, admin dashboard html css, svg line chart, donut chart css, kpi dashboard free',
        'what' => [
        ...
        'when' => ['Analytics and reporting tools', 'Shop and SaaS admin panels', 'Client reports', 'Internal KPI screens'],
        'features' => ['Four KPI cards with change versus last period', 'SVG line chart with previous period for comparison', 'Date range switch for 7, 30 and 90 days', 'Donut chart made with conic-gradient', 'Top pages table with inline bars'],
        ...
        'faq' => [
            ['How do you draw a line chart without a library?', 'Turn each data point into x and y positions and join them into an SVG path with M and L commands. Close the path along the bottom for the filled area.'],
            ['How do you make a donut chart in CSS?', 'Use conic-gradient with a slice for each value, then cut out the middle with a radial-gradient mask.'],
            ['How do I use my own data?', 'Replace the sample series in the script with your numbers or with data from your API.'],
        ],
    ],
    [
        'num' => 97, 'cat' => '10-business-ready', 'slug' => '097-blog', 'name' => 'Blog',
        'example' => 'Small Kitchen Diaries, a food blog',
        'title' => 'Free Blog Template in HTML and CSS for Writers (Live Demo)',
        'desc' => 'Free blog template for a food blog. Featured post, post list with tags and reading time, topic filter, author box and newsletter sign up. Live demo.',
        'keywords' => 'blog template html css, free blog template, food blog template, personal blog design, newsletter blog layout',
        'what' => [
        ...
        'when' => ['Food, travel and hobby blogs', 'Company blogs', 'Newsletters with a web archive', 'Personal writing sites'],
        'features' => ['Large featured post with image', 'Post list with tag, summary and reading time', 'Topic filter buttons that work', 'Author box and newsletter sign up', 'Fraunces and Source Sans type pairing'],
        'css' => ".feat { display: grid; grid-template-columns: 1.2fr 1fr; gap: 34px; align-items: center; }\n.layout { display: grid; grid-template-columns: 1fr 300px; gap: 40px; }\n.post { display: grid; grid-template-columns: 160px 1fr; gap: 20px; border-bottom: 1px solid #ece4d8; }\n.post h2 { font-family: Fraunces, serif; font-size: 1.35rem; }",
        'faq' => [
            ['Can I use this blog template with a CMS?', 'Yes. Use it as the design for Ghost, WordPress, Eleventy or any static site generator, and fill the posts from your content.'],
            ['Is this layout good for SEO?', 'Yes. It uses real headings, short summaries and clear links, which help Google understand each post.'],
            ['How do I add more posts?', 'Copy one .post block, change the text and link, and set data-t to its topic so the filter works.'],
        ],
    ],
    [
        'num' => 98, 'cat' => '10-business-ready', 'slug' => '098-link-in-bio', 'name' => 'Link in Bio',
        'example' => 'Juno Hale, a musician',
        'title' => 'Free Link in Bio Page Template (Linktree Alternative)',
        'desc' => 'Free link in bio template for a musician. Mobile first page with big link buttons, tour dates and social links. A free Linktree alternative. Live demo.',
        'keywords' => 'link in bio template, linktree alternative free, bio link page html, musician link page, instagram bio link template',
        'what' => [
        ...
        'when' => ['Musicians and artists', 'Creators and influencers', 'Small businesses on social media', 'Event and campaign links'],
        'features' => ['Mobile first single column', 'Gradient ring around the profile picture', 'One highlighted main link', 'Tour dates with ticket links', 'Social profile buttons'],
        'css' => "main { max-width: 460px; margin: 0 auto; padding: 46px 20px 30px; text-align: center; }\n.links a {\n  display: block; padding: 16px; border-radius: 16px; margin-bottom: 12px;\n  background: #221b2b; font-weight: 700;\n}\n.links a.hl { background: linear-gradient(90deg, #ff8a5c, #b98cff); color: #1a1020; }\n.av { border-radius: 50%; padding: 4px; background: conic-gradient(#ff8a5c, #b98cff, #ff8a5c); }",
        'faq' => [
            ['Can I use this instead of Linktree?', 'Yes. Host this single file on GitHub Pages or Netlify for free and put its link in your bio.'],
            ['Can I use my own domain?', 'Yes. GitHub Pages and Netlify both let you connect a custom domain for free.'],
            ['How do I track clicks?', 'Add a privacy friendly analytics script like Plausible or GoatCounter to the page.'],
        ],
    ],
    [
        'num' => 99, 'cat' => '10-business-ready', 'slug' => '099-waitlist', 'name' => 'Waitlist Page',
        'example' => 'Brightwell, a sleep app before launch',
        'title' => 'Free Waitlist and Coming Soon Page Template with Countdown',
        'desc' => 'Free waitlist and coming soon template for an app launch. Live countdown, email sign up that shows your place in line, and a referral link. Live demo.',
        'keywords' => 'waitlist page template, coming soon page html, countdown timer html, launch page template, referral waitlist',
        'what' => [
        ...
        'when' => ['App and product launches', 'Beta sign ups', 'Events and ticket drops', 'New shops before opening'],
        'features' => ['Live countdown in days, hours, minutes and seconds', 'Single field email form', 'Place in line shown after sign up', 'Referral link with a copy button', 'Night sky style with a CSS moon'],
        'css' => ".cd { display: flex; justify-content: center; gap: 12px; }\n.cd div { width: 84px; padding: 14px 0; border-radius: 14px; background: rgba(255,255,255,.06); }\n.cd b { font-size: 2rem; font-variant-numeric: tabular-nums; }\nform:focus-within { border-color: #ffcf70; }\n.moon { border-radius: 50%; background: #ffcf70; box-shadow: inset -18px -6px 0 #e0a93f, 0 0 50px rgba(255,207,112,.35); }",
        'faq' => [
            ['How do I set the launch date?', 'Change the launch variable at the top of the script to your real date and time.'],
            ['Why use tabular-nums on the countdown?', 'It makes every digit the same width, so the numbers do not jump around each second.'],
            ['Where do the emails go?', 'Nowhere yet. Connect the form to a tool like Mailchimp, Loops or a Google Sheet to store them.'],
        ],
    ],
    [
        'num' => 100, 'cat' => '10-business-ready', 'slug' => '100-directory-listing', 'name' => 'Directory Listing',
        'example' => 'Course Compass, a college finder',
        'title' => 'Free Directory Listing Template with Search and Filters',
        'desc' => 'Free directory listing template for a college finder. Live search, filters by city, subject and fees, sort, result count and listing cards. Live demo.',
        'keywords' => 'directory website template, listing page html, search filter javascript, college directory template, business directory html',
        'what' => [
        ...
        'when' => ['School and college directories', 'Business and service listings', 'Job boards', 'Real estate and rental listings'],
        'features' => ['Live search by name or subject', 'City and subject checkboxes built from the data', 'Maximum fee slider', 'Sort by name or fees', 'Empty state with advice when nothing matches'],
        'css' => ".layout { display: grid; grid-template-columns: 240px 1fr; gap: 28px; }\naside { position: sticky; top: 16px; align-self: start; }\n.card { display: grid; grid-template-columns: 88px 1fr auto; gap: 18px; border-radius: 14px; }\n.search div:focus-within { box-shadow: 0 0 0 3px #e0621f, 0 12px 30px rgba(23,32,43,.12); }",
        'faq' => [
            ['How do I add my own listings?', 'Edit the list at the top of the script. Each entry has a name, city, subject, fee, open status and color.'],
            ['Will this work with hundreds of listings?', 'For a few hundred, yes. For thousands, load results from a search API such as Algolia or Meilisearch and keep this layout.'],
            ['Is a directory page good for SEO?', 'Yes, especially with a page per listing. Render each listing in HTML and add schema markup for the type of place.'],
        ],
    ],
