...
$CATEGORIES = [
    ...
    [
        ...
        'name' => 'Motion',
        'ready' => true,
        'keywords' => 'css animation templates, scroll driven animation, view transitions, parallax, marquee css, skeleton loader',
        'title' => 'Free CSS Animation Templates: Scroll, Parallax, Marquee',
        'desc' => '10 free CSS motion templates with live demos. Scroll driven animation, View Transitions, parallax, marquee, skeleton loaders and custom cursors.',
        'intro' => 'Good motion explains what just happened and where to look next. These ten templates cover the animations people search for most, from brand new CSS like scroll driven animations and View Transitions to classics like parallax, marquees and skeleton loaders. Every one respects reduced motion settings, and most use little or no JavaScript.',
    ],
    [
        'num' => 8,
        'slug' => '08-3d-depth',
        'name' => '3D and Depth',
        'ready' => true,
        'keywords' => 'css 3d templates, 3d tilt card, isometric css, flip card css, css 3d box, stacked cards scroll',
        'title' => 'Free CSS 3D Templates: Tilt Cards, Flip Cards, Isometric',
        'desc' => '10 free CSS 3D and depth templates with live demos. Tilt cards, isometric boxes, layered shadows, flip cards, a 3D product box and spatial UI.',
        'intro' => 'Depth makes a screen feel like a place. These ten templates show how far plain CSS can go in three dimensions: cards that tilt toward your cursor, isometric boxes, shadows that look real, cards that flip, a product box you can turn, floating glass windows and cards that stack as you scroll. No 3D library needed.',
    ],
    [
        'num' => 9,
        ...
        'ready' => true,
        'keywords' => 'aesthetic website templates, japandi website, cottagecore website, dark academia, art deco css, islamic geometric pattern',
        'title' => 'Free Aesthetic Website Templates: Japandi, Art Deco and More',
        'desc' => '10 free aesthetic website templates. Japandi, Scandinavian, cottagecore, dark academia, vaporwave, solarpunk, Bauhaus, Art Deco, Islamic and guochao.',
        'intro' => 'Some styles come from a place or a time, and people search for them by name. This category covers ten of them, each built for a business that really fits it: a Japandi ceramics shop, Norwegian cabins, a cottagecore jam farm, a dark academia book club, a vaporwave music label, a solarpunk energy co-op, a Bauhaus exhibition, an Art Deco bar, a riad in Marrakech and a guochao mooncake bakery.',
    ],
    [
        'num' => 10,
...
.mini { box-shadow: 4px 4px 0 #e9e2d2, 8px 8px 0 #d8cfbb; }',
    ...
    [
        'num' => 61, 'cat' => '07-motion', 'slug' => '061-scroll-driven', 'name' => 'Scroll Driven Animation',
        'example' => 'Volt Ride, an e-bike product page',
        'title' => 'Free CSS Scroll Driven Animation Template (No JavaScript)',
        'desc' => 'Free scroll driven animation template for an e-bike. Progress bar, reveals and a bike that rides as you scroll, using CSS animation-timeline. Live demo.',
        'keywords' => 'scroll driven animations css, animation-timeline, scroll timeline css, view timeline, css scroll animation no javascript',
        'what' => [
        ...
        'when' => ['Product pages that tell a story', 'Reading progress bars on articles', 'Reveal effects without JavaScript', 'Landing pages with a clear sequence'],
        'features' => ['Reading progress bar with scroll(root)', 'Bike that rides as its section passes', 'Stat cards that rise with view() and animation-range', 'Headline lines that light up one by one', 'Safe fallback with @supports and reduced motion'],
        ...
        'faq' => [
            ['What are CSS scroll driven animations?', 'They are normal CSS keyframe animations whose progress follows scrolling instead of time, set with animation-timeline: scroll() or view().'],
            ['Which browsers support animation-timeline?', 'Chrome, Edge and Safari 26 support it. Firefox is still working on it, so this template wraps the effects in @supports and the page works fine without them.'],
            ['What does animation-range do?', 'It sets which part of the scroll the animation uses. entry 0% cover 30% means it runs from when the element starts entering until it covers 30% of the view.'],
        ],
    ],
    [
        'num' => 62, 'cat' => '07-motion', 'slug' => '062-view-transitions', 'name' => 'View Transitions',
        'example' => 'Fork and Field, a recipe site',
        'title' => 'Free View Transitions API Template: Card to Detail Morph',
        'desc' => 'Free View Transitions API template for a recipe site. Click a card and its picture and title morph smoothly into a full recipe view, then back. Live demo.',
        'keywords' => 'view transitions api, startviewtransition, view-transition-name, page transition css, shared element transition',
        'what' => [
        ...
        'when' => ['Card grids that open into detail pages', 'Photo galleries', 'Online shops, product to product page', 'Any single page app with views'],
        'features' => ['Card image and title morph into the detail view', 'Smooth reverse when you go back', 'Focus moves to the right place for keyboard users', 'Works as a normal switch in older browsers', 'Turns off for reduced motion'],
        ...
        'faq' => [
            ['What is the View Transitions API?', 'It is a browser feature that animates between two states of the page. You make the change inside startViewTransition() and the browser handles the animation.'],
            ['What does view-transition-name do?', 'It tells the browser that two elements, one before and one after the change, are the same thing, so it morphs one into the other.'],
            ['Can I use view transitions between separate pages?', 'Yes. Add @view-transition { navigation: auto; } to both pages on the same site. Chrome, Edge and Safari support it.'],
        ],
    ],
    [
        'num' => 63, 'cat' => '07-motion', 'slug' => '063-micro-interactions', 'name' => 'Micro Interactions',
        'example' => 'Streak, a habit tracker',
        'title' => 'Free CSS Micro Interactions Template: Checkbox, Like, Toggle',
        'desc' => 'Free micro interactions template for a habit tracker. Animated checkboxes, a like button that pops, a springy switch and copy feedback. Live demo.',
        'keywords' => 'micro interactions css, animated checkbox css, like button animation, toggle switch css, button feedback animation',
        'what' => [
        ...
        'when' => ['Habit, task and fitness apps', 'Settings screens', 'Social features like likes and follows', 'Share and copy buttons'],
        'features' => ['Checkbox tick that draws with stroke-dashoffset', 'Heart that fills and pops on like', 'Toggle switch with a springy bounce', 'Copy button that turns green and says Copied', 'Counter that bumps when it changes'],
        'css' => ".box svg { stroke-dasharray: 20; stroke-dashoffset: 20; transition: stroke-dashoffset .25s; }\n.hab input:checked + .box { background: #16a34a; transform: scale(1.08); }\n.hab input:checked + .box svg { stroke-dashoffset: 0; }\n\n.sw::after { transition: transform .25s cubic-bezier(.3, 1.5, .6, 1); }\n.sw[aria-checked=\"true\"]::after { transform: translateX(22px); }",
        'faq' => [
            ['What are micro interactions?', 'They are small animated responses to a user action, like a checkbox ticking, a button pressing in or a like icon filling.'],
            ['How do I make a springy toggle switch?', 'Use a transition with a cubic-bezier that goes past 1, such as cubic-bezier(.3, 1.5, .6, 1). The knob slightly overshoots and settles.'],
            ['Are custom checkboxes accessible?', 'Yes if you keep the real input. This template hides the input visually but keeps it in the page, so keyboards and screen readers still work.'],
        ],
    ],
    [
        'num' => 64, 'cat' => '07-motion', 'slug' => '064-parallax', 'name' => 'Layered Parallax',
        'example' => 'Pinecrest, a campground',
        'title' => 'Free Layered Parallax Scrolling Template in HTML and CSS',
        'desc' => 'Free layered parallax website template for a campground. Sun, mountains and trees move at different speeds as you scroll, drawn with SVG. Live demo.',
        'keywords' => 'parallax scrolling template, layered parallax css, mountain parallax, parallax website html, svg parallax',
        'what' => [
        ...
        'when' => ['Campsites, hotels and outdoor brands', 'Travel and adventure stories', 'Game and film landing pages', 'Kids and storytelling sites'],
        'features' => ['Five layers moving at different speeds', 'Mountains and pine trees drawn with SVG', 'Smooth updates with requestAnimationFrame', 'Speed set per layer with a data attribute', 'Parallax off for reduced motion'],
        'css' => ".ly { position: absolute; left: 0; right: 0; bottom: 0; will-change: transform; }\n\n/* JS: move each layer by its own speed */\nconst layers = document.querySelectorAll('[data-s]');\naddEventListener('scroll', () => requestAnimationFrame(() => {\n  layers.forEach(l => l.style.transform = `translateY(\${scrollY * l.dataset.s}px)`);\n}), { passive: true });",
        'faq' => [
            ['What is parallax scrolling?', 'It is when background layers move slower than foreground layers while you scroll, which creates a feeling of depth.'],
            ['Is parallax bad for performance?', 'Not if you only use transform and update once per frame with requestAnimationFrame, like this template.'],
            ['Can I make parallax with only CSS?', 'Yes, with scroll driven animations (see design 061) in browsers that support them. The small script here works everywhere.'],
        ],
    ],
    [
        'num' => 65, 'cat' => '07-motion', 'slug' => '065-marquee', 'name' => 'Marquee Ticker',
        'example' => 'Northline, a design studio',
        'title' => 'Free CSS Infinite Marquee Template: Logos and Reviews',
        'desc' => 'Free CSS marquee template for a design studio. Endless scrolling client logos, reviews and a big text line that pause on hover, with faded edges. Live demo.',
        'keywords' => 'css marquee, infinite scroll logos css, logo carousel css, scrolling text css, testimonial marquee',
        'what' => [
        ...
        'when' => ['Client and partner logos', 'Customer reviews', 'Announcements and offers', 'Big brand statements'],
        'features' => ['Gap free loop by doubling the content', 'Pause on hover and keyboard focus', 'Faded edges with a CSS mask', 'Rows with different speeds and directions', 'Stops and wraps for reduced motion'],
        'css' => ".mq { overflow: hidden;\n  mask: linear-gradient(90deg, transparent, #000 10%, #000 90%, transparent); }\n.track { display: flex; width: max-content;\n  animation: scroll var(--t, 30s) linear infinite; }\n.mq:hover .track { animation-play-state: paused; }\n@keyframes scroll { to { transform: translateX(-50%); } }",
        'faq' => [
            ['How do you make an infinite marquee in CSS?', 'Put the items in a flex track twice, then animate the track from translateX(0) to translateX(-50%). When it reaches half, it looks exactly like the start.'],
            ['Is the old HTML marquee tag still OK?', 'No. It is obsolete. The CSS version is smoother, accessible and easy to pause.'],
            ['How do I stop screen readers reading the logos twice?', 'Add aria-hidden="true" to the copied set, as this template does.'],
        ],
    ],
    [
        'num' => 66, 'cat' => '07-motion', 'slug' => '066-morphing-blobs', 'name' => 'Morphing Blobs',
        'example' => 'Bloom, a therapy practice',
        'title' => 'Free CSS Morphing Blob Animation Template (Live Demo)',
        'desc' => 'Free morphing blob template for a therapy practice. Soft shapes slowly change form with animated border-radius and overlap with multiply. Pure CSS. Live demo.',
        'keywords' => 'morphing blob css, blob animation css, border radius animation, organic shape css, animated blob background',
        'what' => [
        ...
        'when' => ['Therapy, coaching and wellness', 'Education and kids apps', 'Soft SaaS hero sections', 'Icons and avatar backgrounds'],
        'features' => ['Three overlapping blobs that change shape', 'Colors blend where blobs overlap', 'Small blob icons on each service card', 'Different speeds so they never sync', 'Motion stops for reduced motion'],
        ...
        'faq' => [
            ['How do you make a morphing blob in CSS?', 'Give an element an eight value border-radius, like 42% 58% 63% 37% / 41% 45% 55% 59%, and animate between a few different sets of values.'],
            ['Can I use SVG instead?', 'Yes, but the CSS way is lighter and easier to recolor. SVG paths give more complex shapes.'],
            ['Will blob animations slow the page?', 'Animating border-radius on a few elements is fine. Avoid dozens of large blobs on one page.'],
        ],
    ],
    [
        'num' => 67, 'cat' => '07-motion', 'slug' => '067-hover-reveal', 'name' => 'Hover Reveal',
        'example' => 'Studio Halden, an interior design studio',
        'title' => 'Free Hover Image Reveal Template: Follows the Cursor',
        'desc' => 'Free hover reveal template for an interior design studio. Hover a project name and its picture fades in and smoothly follows your cursor. Live demo.',
        'keywords' => 'hover image reveal, image follow cursor css, hover list animation, portfolio hover effect, project list template',
        'what' => [
        ...
        'when' => ['Interior and architecture studios', 'Photography portfolios', 'Agency case study lists', 'Restaurant and menu pages'],
        'features' => ['Big serif project names in a list', 'Picture fades in and follows the cursor smoothly', 'Other items dim while one is hovered', 'Name shifts and turns italic on hover and focus', 'Hidden on touch devices'],
        ...
        'faq' => [
            ['How do you make an image follow the cursor?', 'Use a position: fixed element and update its left and top on pointermove. Easing it toward the cursor each frame makes it smooth.'],
            ['Is hover reveal OK on phones?', 'Phones have no hover, so the preview is hidden with @media (hover: none) and the list stays as plain links.'],
            ['Can I use real photos?', 'Yes. Set a background-image on the preview from a data attribute on each link.'],
        ],
    ],
    [
        'num' => 68, 'cat' => '07-motion', 'slug' => '068-staggered-entrance', 'name' => 'Staggered Entrance',
        'example' => 'Pipeline, a CRM landing page',
        'title' => 'Free Staggered Animation CSS Template: Page Load Entrance',
        'desc' => 'Free staggered entrance template for a CRM landing page. Headline words, buttons and board cards appear one after another on load. Pure CSS. Live demo.',
        'keywords' => 'staggered animation css, css animation delay, page load animation, fade in up css, entrance animation template',
        'what' => [
        ...
        'when' => ['SaaS landing pages', 'Dashboards on first load', 'Portfolio home pages', 'Onboarding screens'],
        'features' => ['Headline that appears one word at a time', 'Delay order set with a --d number per element', 'Kanban board cards that land in sequence', 'One shared keyframe for everything', 'Everything shows at once for reduced motion'],
        'css' => ".in {\n  opacity: 0;\n  animation: enter .7s cubic-bezier(.2, .8, .2, 1) forwards;\n  animation-delay: calc(var(--d, 0) * 90ms + 100ms);\n}\n@keyframes enter {\n  from { opacity: 0; transform: translateY(22px); }\n  to   { opacity: 1; transform: none; }\n}",
        'faq' => [
            ['How do you stagger animations in CSS?', 'Give each element a number with a custom property, like style="--d:3", and set animation-delay: calc(var(--d) * 90ms).'],
            ['Does a load animation hurt SEO?', 'No. The content is in the HTML from the start. Keep the total time short so the page feels fast.'],
            ['What if someone prefers reduced motion?', 'The template turns the animation off and shows everything at full opacity right away.'],
        ],
    ],
    [
        'num' => 69, 'cat' => '07-motion', 'slug' => '069-skeleton-loaders', 'name' => 'Skeleton Loaders',
        'example' => 'Morning Brief, a news app',
        'title' => 'Free CSS Skeleton Loader Template with Shimmer (Live Demo)',
        'desc' => 'Free skeleton loader template for a news app. Grey shimmer placeholders show while content loads, then real stories fade in. Pure CSS shimmer. Live demo.',
        'keywords' => 'skeleton loader css, skeleton screen, shimmer effect css, loading placeholder css, content loading animation',
        'what' => [
        ...
        'when' => ['News and social feeds', 'Dashboards that fetch data', 'Online shop product grids', 'Any page that loads from an API'],
        'features' => ['Skeleton cards that match the real layout', 'Shimmer made with one moving gradient', 'Real content fades in after loading', 'aria-busy tells screen readers it is loading', 'Reload button to see it again'],
        ...
        'faq' => [
            ['What is a skeleton screen?', 'It is a placeholder version of the page, made of grey shapes, shown while the real content loads.'],
            ['Are skeleton loaders better than spinners?', 'For content like feeds and cards, yes. They show the layout early and make loading feel faster.'],
            ['How do I use this with real data?', 'Show the skeleton, fetch your data, then replace the skeleton with the real cards when the request finishes.'],
        ],
    ],
    [
        'num' => 70, 'cat' => '07-motion', 'slug' => '070-cursor-effects', 'name' => 'Cursor Effects',
        'example' => 'Oddfellow, a creative studio',
        'title' => 'Free Custom Cursor and Magnetic Button Template (Live Demo)',
        'desc' => 'Free custom cursor template for a creative studio. A smooth following ring, a dot, magnetic buttons and a cursor that grows over links. Live demo.',
        'keywords' => 'custom cursor css, magnetic button, cursor follow effect, mouse follower javascript, creative agency website',
        'what' => [
        ...
        'when' => ['Creative agencies and studios', 'Designer and developer portfolios', 'Fashion and art sites', 'Interactive campaign pages'],
        'features' => ['Dot plus smooth trailing ring cursor', 'Ring grows and inverts colors over links', 'Magnetic buttons that follow the pointer', 'Only on devices with a fine pointer', 'Keeps normal focus rings for keyboard users'],
        ...
        'faq' => [
            ['How do you make a custom cursor?', 'Hide the default cursor with cursor: none, then move a fixed element to the mouse position on pointermove. Add pointer-events: none so it never blocks clicks.'],
            ['How does a magnetic button work?', 'On pointermove over the button, measure how far the cursor is from its center and move the button a fraction of that distance with transform.'],
            ['Is a custom cursor bad for accessibility?', 'It can be if it hides the real pointer on touch or breaks focus. This template only runs on fine pointers and keeps visible focus outlines.'],
        ],
    ],

    [
        'num' => 71, 'cat' => '08-3d-depth', 'slug' => '071-3d-tilt-cards', 'name' => '3D Tilt Cards',
        'example' => 'Postcard Club, a postcard subscription',
        'title' => 'Free 3D Tilt Card Hover Effect with Glare (Live Demo)',
        'desc' => 'Free 3D tilt card template for a postcard subscription. Cards lean toward your cursor with a moving glare and layers that pop out in depth. Live demo.',
        'keywords' => '3d tilt card css, tilt hover effect, card glare effect, perspective card css, vanilla tilt alternative',
        'what' => [
        ...
        'when' => ['Product and collectible cards', 'Portfolio thumbnails', 'Pricing and plan cards', 'Travel and event promos'],
        'features' => ['Tilt that follows the cursor on each card', 'Moving glare with a radial gradient', 'Stamp and title raised with translateZ', 'Smooth return when the cursor leaves', 'Tilt off for reduced motion'],
        'css' => ".row { perspective: 1000px; }\n.card {\n  transform-style: preserve-3d;\n  transform: rotateX(var(--rx)) rotateY(var(--ry));\n  transition: transform .3s ease-out;\n}\n.card::after {\n  content: \"\"; position: absolute; inset: 0; border-radius: inherit;\n  background: radial-gradient(circle at var(--gx) var(--gy), rgba(255,255,255,.45), transparent 50%);\n}\n.name { transform: translateZ(60px); }",
        'faq' => [
            ['How do you make a 3D tilt effect without a library?', 'Set perspective on the parent, then on pointermove calculate where the cursor is on the card and set rotateX and rotateY from that. About six lines of JavaScript.'],
            ['How do I make parts of the card pop out?', 'Add transform-style: preserve-3d to the card and give inner elements translateZ values, like 20px for the picture and 60px for the title.'],
            ['Does tilt work on phones?', 'Phones have no hover, so the cards stay flat and still look good. You could add device orientation later if you want.'],
        ],
    ],
    [
        'num' => 72, 'cat' => '08-3d-depth', 'slug' => '072-isometric', 'name' => 'Isometric',
        'example' => 'Stackyard, a fulfillment warehouse',
        'title' => 'Free Isometric CSS Template: 3D Boxes on a Grid (Live Demo)',
        'desc' => 'Free isometric website template for a fulfillment warehouse. 3D boxes, a grid floor and a moving conveyor, all built with CSS transforms. Live demo.',
        'keywords' => 'isometric css, isometric design website, css 3d box, isometric illustration css, isometric grid',
        'what' => [
        ...
        'when' => ['Logistics and warehouse companies', 'SaaS and infrastructure products', 'Games and city builders', 'Process and how it works sections'],
        'features' => ['Isometric grid floor made with gradients', 'Stackable 3D boxes built from three faces', 'Box size and height set per box with variables', 'Two box colors for variety', 'Moving conveyor belt that stops for reduced motion'],
        'css' => ".floor { transform: rotateX(60deg) rotateZ(-45deg); transform-style: preserve-3d; }\n.box { position: absolute; width: var(--s, 60px); height: var(--s, 60px); transform-style: preserve-3d; }\n.box .t { inset: 0; transform: translateZ(var(--h, 60px)); }\n.box .l { bottom: 0; width: 100%; height: var(--h, 60px); transform-origin: bottom; transform: rotateX(-90deg); }\n.box .r { right: 0; width: var(--h, 60px); height: 100%; transform-origin: right; transform: rotateY(90deg); }",
        'faq' => [
            ['How do you make an isometric view in CSS?', 'Rotate a flat element with transform: rotateX(60deg) rotateZ(-45deg). Anything inside it with preserve-3d then sits on an isometric plane.'],
            ['How do I build a 3D box with CSS?', 'Use three faces: a top moved up with translateZ, and two sides folded down with rotateX(-90deg) and rotateY(90deg) from their edges.'],
            ['Should I use SVG for isometric art instead?', 'For detailed illustrations, SVG is easier. CSS boxes are great when you want parts you can change with code, like stock levels.'],
        ],
    ],
    [
        'num' => 73, 'cat' => '08-3d-depth', 'slug' => '073-layered-shadows', 'name' => 'Layered Shadows',
        'example' => 'Forma, a furniture maker',
        'title' => 'Free Layered Box Shadow CSS Template: Realistic Depth',
        'desc' => 'Free layered shadows template for a furniture shop. Realistic multi layer box shadows in three elevation levels that lift cards on hover. Live demo.',
        'keywords' => 'layered box shadow css, realistic shadow css, smooth shadow, elevation css, soft shadow generator',
        'what' => [
        ...
        'when' => ['Product cards in online shops', 'Premium and luxury brands', 'Dashboards with cards and modals', 'Any design that needs soft, natural depth'],
        'features' => ['Three reusable elevation levels', 'Up to seven stacked shadow layers', 'Warm shadow color tuned to the background', 'Cards lift and deepen on hover', 'Chairs drawn with CSS'],
        'css' => ":root { --sh: 30deg 20% 20%; }\n.e3 {\n  box-shadow:\n    0 1px 1px hsl(var(--sh) / .07), 0 2px 2px hsl(var(--sh) / .07),\n    0 4px 4px hsl(var(--sh) / .07), 0 8px 8px hsl(var(--sh) / .07),\n    0 16px 16px hsl(var(--sh) / .07), 0 32px 32px hsl(var(--sh) / .07),\n    0 64px 64px hsl(var(--sh) / .07);\n}",
        'faq' => [
            ['How do you make realistic shadows in CSS?', 'Stack several box shadows that double in size each time, like 1px, 2px, 4px, 8px, each with low opacity. Together they look soft and natural.'],
            ['Why not use pure black shadows?', 'Real shadows pick up the color of the surface. A dark tint of your background color looks much more natural than grey.'],
            ['Do many shadows slow down the page?', 'A few cards with layered shadows are fine. Avoid animating box-shadow on hundreds of elements at once.'],
        ],
    ],
    [
        'num' => 74, 'cat' => '08-3d-depth', 'slug' => '074-floating-elements', 'name' => 'Floating Elements',
        'example' => 'Driftwood, a to-do app',
        'title' => 'Free Floating Elements App Landing Page Template',
        'desc' => 'Free floating elements template for an app launch. UI cards gently hover around a CSS phone mockup with soft shadows and slow motion. Live demo.',
        'keywords' => 'floating animation css, app landing page template, phone mockup css, floating cards hero, hover float css',
        'what' => [
        ...
        'when' => ['Mobile app landing pages', 'SaaS feature highlights', 'Product launches', 'Waitlist pages'],
        'features' => ['Phone mockup built in HTML and CSS', 'Four floating cards with real text', 'Different speed and delay per card', 'Soft layered shadows under each card', 'Floating stops for reduced motion'],
        ...
        'faq' => [
            ['How do you make elements float in CSS?', 'Animate a small translateY up and down with ease-in-out, for example translateY(-16px) at 50%, and loop it forever.'],
            ['How do I stop them moving together?', 'Give each element a different animation-duration and a negative animation-delay so they start at different points.'],
            ['Can I put a real screenshot in the phone?', 'Yes. Replace the list inside .phone with an img of your app screen.'],
        ],
    ],
    [
        'num' => 75, 'cat' => '08-3d-depth', 'slug' => '075-perspective-scroll', 'name' => 'Perspective Scroll',
        'example' => 'Fieldnote, a year in review page',
        'title' => 'Free 3D Perspective Scroll Template: Year in Review',
        'desc' => 'Free perspective scroll template for a year in review page. Big stat panels tip back in 3D and flatten out as they reach the middle of the screen. Live demo.',
        'keywords' => '3d scroll effect, perspective scroll css, year in review template, rotatex scroll, scroll 3d cards',
        'what' => [
        ...
        'when' => ['Year in review and wrapped pages', 'Big number and stat stories', 'Product feature tours', 'Portfolio highlights'],
        'features' => ['Panels that tip back and flatten on scroll', 'Rotation hinged on the bottom edge', 'Slight scale for extra depth', 'Updates once per frame with requestAnimationFrame', 'Flat and still for reduced motion'],
        'css' => ".stage { perspective: 1200px; }\n.pn {\n  transform: rotateX(var(--r)) scale(var(--s));\n  transform-origin: 50% 100%;\n  will-change: transform;\n}\n/* JS: d = distance from screen center, -1 to 1 */\n/* --r = d > 0 ? d * 38deg : d * -12deg */",
        'faq' => [
            ['How do you tilt elements in 3D on scroll?', 'Put perspective on the parent and change each element rotateX based on its position on screen, read with getBoundingClientRect during scroll.'],
            ['Why use transform-origin at the bottom?', 'It makes the panel hinge on its bottom edge, like a card being laid down, instead of spinning around its middle.'],
            ['Can this be done with only CSS?', 'Yes, in browsers that support scroll driven animations, with animation-timeline: view(). The script version works everywhere.'],
        ],
    ],
    [
        'num' => 76, 'cat' => '08-3d-depth', 'slug' => '076-flip-cards', 'name' => 'Flip Cards',
        'example' => 'Palabra, a Spanish flashcard app',
        'title' => 'Free 3D Flip Card CSS Template: Flashcards (Live Demo)',
        'desc' => 'Free 3D flip card template for a language app. Click or press Enter to flip a flashcard and see the answer on the back, with a progress bar. Live demo.',
        'keywords' => 'flip card css, 3d card flip, flashcard html css, backface visibility, flip animation css',
        'what' => [
        ...
        'when' => ['Flashcards and quizzes', 'Team and people cards', 'Product features with details', 'Games and memory puzzles'],
        'features' => ['Smooth 3D flip with a small bounce', 'Real buttons with aria-pressed', 'Works with click, tap, Enter and Space', 'Progress bar counts cards you have seen', 'Front and back use lang for correct pronunciation'],
        'css' => ".deck { perspective: 1000px; }\n.in { transform-style: preserve-3d; transition: transform .6s cubic-bezier(.3, 1.3, .6, 1); }\n.fc[aria-pressed=\"true\"] .in { transform: rotateY(180deg); }\n.face { position: absolute; inset: 0; backface-visibility: hidden; }\n.back { transform: rotateY(180deg); }",
        'faq' => [
            ['How do you make a flip card in CSS?', 'Stack two faces inside a wrapper with preserve-3d, hide their backs with backface-visibility: hidden, rotate the back face 180deg, then rotate the wrapper 180deg to flip.'],
            ['Should flip cards use hover or click?', 'Click is better. Hover does not work on phones and can flip by accident. This template uses buttons.'],
            ['Are flip cards accessible?', 'Yes, when they are buttons with aria-pressed and the back text is announced, as in this template.'],
        ],
    ],
    [
        'num' => 77, 'cat' => '08-3d-depth', 'slug' => '077-3d-product', 'name' => '3D Product Box',
        'example' => 'Kettle Lane, a tea brand',
        'title' => 'Free CSS 3D Product Box Template: Drag to Rotate',
        'desc' => 'Free 3D product template for a tea brand. A real CSS 3D box with a label on every side spins slowly and turns when you drag it or use arrow keys. Live demo.',
        'keywords' => 'css 3d box, 3d product viewer css, rotate cube css, drag to rotate, packaging mockup html',
        'what' => [
        ...
        'when' => ['Tea, coffee and food packaging', 'Cosmetics and gift boxes', 'Books and game boxes', 'Packaging design portfolios'],
        'features' => ['Six sided box built in pure CSS', 'Box size set with three variables', 'Slow automatic spin', 'Drag, touch or arrow keys to rotate', 'Soft ground shadow under the box'],
        'css' => ".box { --w: 180px; --h: 260px; --d: 120px; transform-style: preserve-3d;\n  transform: rotateX(-12deg) rotateY(var(--ry, 30deg)); }\n.fr { transform: translateZ(calc(var(--d) / 2)); }\n.bk { transform: rotateY(180deg) translateZ(calc(var(--d) / 2)); }\n.rt { width: var(--d); transform: rotateY(90deg)  translateZ(calc(var(--w) / 2)); }\n.lf { width: var(--d); transform: rotateY(-90deg) translateZ(calc(var(--w) / 2)); }",
        'faq' => [
            ['How do you make a 3D box in CSS?', 'Create six faces inside a container with transform-style: preserve-3d. Move the front and back out with translateZ, and rotate the sides and top into place before moving them out.'],
            ['How does drag to rotate work?', 'On pointermove, add the horizontal mouse movement to a rotation value and apply it as rotateY on the box.'],
            ['Can I put my own packaging design on it?', 'Yes. Give each face a background-image with your artwork, sized to that face.'],
        ],
    ],
    [
        'num' => 78, 'cat' => '08-3d-depth', 'slug' => '078-spatial-ui', 'name' => 'Spatial UI',
        'example' => 'Habitat, a spatial meeting workspace',
        'title' => 'Free Spatial UI Template Inspired by visionOS (Live Demo)',
        'desc' => 'Free spatial UI template inspired by Apple visionOS. Floating glass windows at different depths over a room, with a floating tab bar. Live demo.',
        'keywords' => 'visionos ui css, spatial ui design, glass window css, apple vision pro design, spatial computing web',
        'what' => [
        ...
        'when' => ['Apps and demos for spatial computing', 'Futuristic product launches', 'Meeting and collaboration tools', 'Concept and portfolio pieces'],
        'features' => ['Three glass windows at different depths', 'Side panels angled toward the viewer', 'Floating ornament tool bar', 'Room background drawn with gradients', 'Flattens into a simple stack on phones'],
        'css' => ".room { perspective: 1400px; }\n.space { transform-style: preserve-3d; }\n.win {\n  border-radius: 30px;\n  background: rgba(128, 128, 128, .28);\n  backdrop-filter: blur(40px) saturate(160%);\n  box-shadow: inset 0 1px 0 rgba(255,255,255,.4), 0 30px 60px rgba(0,0,0,.25);\n}\n.side  { transform: translateZ(-120px) rotateY(18deg); }\n.right { transform: translateZ(-120px) rotateY(-18deg); }",
        'faq' => [
            ['What is spatial UI?', 'It is interface design for 3D spaces, like mixed reality headsets, where windows float around you with depth, glass materials and soft light.'],
            ['How do I make windows look like visionOS glass?', 'Use a semi transparent grey background with strong backdrop-filter blur and saturation, a thin light inner border and a large soft shadow.'],
            ['Does this template work in a headset browser?', 'Yes, it is a normal web page. On a flat screen it uses CSS 3D to fake the depth.'],
        ],
    ],
    [
        'num' => 79, 'cat' => '08-3d-depth', 'slug' => '079-depth-blur', 'name' => 'Depth Blur',
        'example' => 'Terraza, a family winery',
        'title' => 'Free Depth of Field Blur CSS Template (Live Demo)',
        'desc' => 'Free depth blur template for a winery. Near and far layers blur while the middle stays sharp, like a camera lens, and focus shifts on scroll. Live demo.',
        'keywords' => 'depth of field css, blur background css, filter blur layers, camera focus effect, winery website template',
        'what' => [
        ...
        'when' => ['Wineries, farms and food brands', 'Photography and film sites', 'Hotels and travel', 'Any hero that needs a clear focal point'],
        'features' => ['Three scene layers with different blur', 'Grapes and vines drawn with gradients', 'Focus shifts from near to far on scroll', 'Frosted text card that stays readable', 'Focus pull off for reduced motion'],
        'css' => ".far  { filter: blur(6px); }\n.mid  { filter: blur(0); }\n.near { filter: blur(10px); }\n.card { background: rgba(246, 239, 228, .82); backdrop-filter: blur(10px); }\n\n/* JS: shift focus on scroll */\nfar.style.filter = `blur(\${6 - p * 6}px)`;\nmid.style.filter = `blur(\${p * 5}px)`;",
        'faq' => [
            ['How do you create a depth of field effect in CSS?', 'Split the scene into layers and blur the near and far ones with filter: blur(), keeping the focus layer sharp.'],
            ['Is filter: blur() slow?', 'It is fine on a few large layers. Avoid animating heavy blurs on many elements at once, especially on phones.'],
            ['Can I use real photos?', 'Yes. Cut your photo into foreground and background layers as transparent PNGs and blur them separately.'],
        ],
    ],
    [
        'num' => 80, 'cat' => '08-3d-depth', 'slug' => '080-stacked-cards', 'name' => 'Stacked Scroll Cards',
        'example' => 'Harvest Planner, a garden app',
        'title' => 'Free Stacked Cards on Scroll CSS Template (Sticky, No JS)',
        'desc' => 'Free stacked cards template for a garden planner app. Cards pin in place and stack on top of each other as you scroll, using only position sticky. Live demo.',
        'keywords' => 'stacked cards scroll css, sticky cards stack, card stack animation, position sticky cards, scroll stack no javascript',
        'what' => [
        ...
        'when' => ['How it works steps', 'Feature tours on landing pages', 'Case studies and portfolios', 'Pricing or plan comparisons'],
        'features' => ['Cards that stick and stack with no JavaScript', 'Offset per card set with --i', 'Soft shadow on each card edge', 'Four step layout with text and art', 'Works on phones too'],
        'css' => ".sc {\n  position: sticky;\n  top: calc(80px + var(--i) * 28px);\n  height: 420px;\n  border-radius: 28px;\n  margin-bottom: 60px;\n  box-shadow: 0 -10px 30px rgba(0, 0, 0, .08);\n}",
        'faq' => [
            ['How do you stack cards on scroll with CSS?', 'Give every card position: sticky and a top value that increases for each one, like calc(80px + var(--i) * 28px). Each card sticks a little lower than the one before.'],
            ['Why is my sticky card not sticking?', 'A parent with overflow: hidden or a fixed height breaks sticky. Keep the cards inside a normal block with enough space below them.'],
            ['Can the lower cards shrink as new ones arrive?', 'Yes. Add a scroll driven animation or a small script that scales each card down as the next one covers it.'],
        ],
    ],

    [
        'num' => 81, 'cat' => '09-cultural-aesthetic', 'slug' => '081-japandi', 'name' => 'Japandi',
        'example' => 'Mado, a ceramics and homeware shop',
        'title' => 'Free Japandi Website Template: Calm Minimal Design',
        'desc' => 'Free Japandi website template for a ceramics shop. Warm neutrals, oak tones, soft shapes and a calm layout mixing Japanese and Nordic style. Live demo.',
        'keywords' => 'japandi website, japandi design template, minimal homeware website, wabi sabi web design, calm minimal css',
        'what' => [
            'Japandi mixes Japanese calm with Scandinavian comfort. The colors are rice paper, linen, oak and charcoal, the shapes are soft, and there is a lot of empty space so each object can breathe.',
            'The hero is a still life drawn in CSS: pots on an oak shelf and a single branch. The type pairs Shippori Mincho, a Japanese serif, with a quiet sans, and nothing on the page competes for attention.',
        ],
        'when' => ['Homeware, ceramics and furniture shops', 'Interior designers', 'Tea, skincare and wellness brands', 'Architecture and slow living blogs'],
        'features' => ['Warm neutral palette with oak and moss accents', 'CSS still life of pots and a branch on a shelf', 'Shippori Mincho headings for a gentle Japanese feel', 'Underline style text link instead of a loud button', 'Three category columns with plenty of space'],
        'css' => ":root {\n  --rice: #f2ede4; --linen: #e6ddd0; --oak: #b89572;\n  --char: #2f2b27; --moss: #737a5b;\n}\nh1 { font-family: \"Shippori Mincho\", serif; font-weight: 500; line-height: 1.3; }\n.pot { border-radius: var(--r); box-shadow: inset -10px -6px 18px rgba(0, 0, 0, .12); }\n.btn { border-bottom: 1px solid var(--char); padding-bottom: 4px; }",
        'faq' => [
            ['What is Japandi design?', 'Japandi is a mix of Japanese and Scandinavian design: minimal, calm and natural, with warm neutral colors, wood and handmade objects.'],
            ['Which colors are Japandi?', 'Off white, beige, oak, soft grey and charcoal, with a muted green or clay as an accent.'],
            ['Which fonts suit a Japandi website?', 'A soft serif like Shippori Mincho or Cormorant for headings, and a light sans such as Zen Kaku Gothic New for text.'],
        ],
    ],
    [
        'num' => 82, 'cat' => '09-cultural-aesthetic', 'slug' => '082-scandinavian', 'name' => 'Scandinavian',
        'example' => 'Fjell, cabin rentals in Norway',
        'title' => 'Free Scandinavian Website Template for Cabin Rentals',
        'desc' => 'Free Scandinavian design template for cabin rentals. Light birch tones, white space, fjord blues, a CSS cabin scene and a booking card. Live demo.',
        'keywords' => 'scandinavian website design, nordic website template, cabin rental website, minimal booking template, hygge web design',
        'what' => [
        ...
        'when' => ['Cabins, hotels and holiday rentals', 'Nordic food and design shops', 'Outdoor and travel brands', 'Calm SaaS and app sites'],
        'features' => ['Mountain and lake scene built with CSS shapes', 'Booking card that overlaps the hero', 'Working form with a confirmation message', 'Birch colored feature cards', 'Light Poppins type throughout'],
        'css' => ".mtn { clip-path: polygon(0 100%, 18% 30%, 30% 60%, 48% 0, 64% 55%, 80% 25%, 100% 100%); }\n.cabin { width: 120px; height: 70px; background: #c8553d; }\n.cabin::before {\n  content: \"\"; position: absolute; left: -10px; right: -10px; top: -44px; height: 46px;\n  background: #2b2b2b; clip-path: polygon(50% 0, 100% 100%, 0 100%);\n}\n.book { margin: -70px 30px 0 auto; border-radius: 20px; box-shadow: 0 20px 50px rgba(35,48,46,.12); }",
        'faq' => [
            ['What makes a website look Scandinavian?', 'Lots of white space, light wood and white backgrounds, muted blues and greens, simple sans serif fonts and friendly rounded shapes.'],
            ['How do I connect the booking form?', 'Point the form to your booking system or a form service like Formspree. The template already checks that a date is chosen.'],
            ['Can I use a photo instead of the CSS scene?', 'Yes. Replace the .pic background with your cabin photo and remove the shape elements.'],
        ],
    ],
    [
        'num' => 83, 'cat' => '09-cultural-aesthetic', 'slug' => '083-cottagecore', 'name' => 'Cottagecore',
        'example' => 'Bramble and Bee, a farm jam shop',
        'title' => 'Free Cottagecore Website Template: Gingham and Flowers',
        'desc' => 'Free cottagecore website template for a jam and flower farm shop. Gingham, CSS flowers, scalloped edges, an arched frame and handwritten labels. Live demo.',
        'keywords' => 'cottagecore website, cottagecore aesthetic css, gingham pattern css, farm shop website template, scalloped border css',
        'what' => [
        ...
        'when' => ['Farm shops and bakeries', 'Florists and gardeners', 'Handmade and craft sellers', 'Tea rooms and small cafes'],
        'features' => ['Gingham pattern made with two gradients', 'Scalloped edges with a radial gradient', 'Arched frame with a dashed stitch line', 'Jam jars with gingham lids and handwritten labels', 'CSS flowers made from five circles'],
        ...
        'faq' => [
            ['What is cottagecore?', 'It is an aesthetic inspired by romantic country life: floral prints, gingham, baking, gardening and a slow, cozy pace.'],
            ['How do you make a gingham pattern in CSS?', 'Layer a horizontal and a vertical stripe gradient, each half transparent, and set background-size to the square size you want.'],
            ['How do I make a scalloped border?', 'Use a repeating radial gradient with transparent circles along one edge, as in the .scal class above.'],
        ],
    ],
    [
        'num' => 84, 'cat' => '09-cultural-aesthetic', 'slug' => '084-dark-academia', 'name' => 'Dark Academia',
        'example' => 'Ravenhall, a reading society',
        'title' => 'Free Dark Academia Website Template for Book Clubs',
        'desc' => 'Free dark academia website template for a book club. Old library browns, candlelight glow, Garamond type and a CSS bookshelf. Live demo.',
        'keywords' => 'dark academia website, dark academia aesthetic css, book club website template, library website design, vintage serif website',
        'what' => [
        ...
        'when' => ['Book clubs and literary societies', 'Bookshops and publishers', 'Writing courses and tutors', 'History and museum blogs'],
        'features' => ['Deep brown palette with oxblood and gold', 'CSS bookshelf with gold bands on each spine', 'Flickering candle with a soft glow', 'EB Garamond and Cinzel type pairing', 'Monthly reading list layout'],
        'css' => ":root { --bg: #1c1612; --gold: #b8955a; --oxblood: #6b1f24; --paper: #e9dfcc; }\nbody { font-family: \"EB Garamond\", serif;\n  background: radial-gradient(ellipse at 70% 10%, rgba(255,190,110,.12), transparent 50%), var(--bg); }\n.candle::before {\n  background: radial-gradient(#fff6c2, #f4a340 70%);\n  box-shadow: 0 0 30px 10px rgba(244, 163, 64, .35);\n  animation: fl 2s ease-in-out infinite;\n}",
        'faq' => [
            ['What is dark academia?', 'It is an aesthetic based on classic literature, old universities and libraries, with dark earthy colors, tweed, candles and serif type.'],
            ['Which fonts suit dark academia?', 'Classic serifs like EB Garamond, Cormorant or Libre Caslon for text, and Cinzel for small capitals and headings.'],
            ['Is a dark page readable for long text?', 'Yes, if the text is a warm off white on dark brown and the font size is generous, as here at 19px.'],
        ],
    ],
    [
        'num' => 85, 'cat' => '09-cultural-aesthetic', 'slug' => '085-vaporwave', 'name' => 'Vaporwave',
        'example' => 'Palm Mall FM, a synth music label',
        'title' => 'Free Vaporwave Website Template in CSS (Live Demo)',
        'desc' => 'Free vaporwave website template for a synth music label. Pink and purple sky, a retro desktop window, a marble bust and a checker floor. Live demo.',
        'keywords' => 'vaporwave website, vaporwave aesthetic css, retro windows 95 css, synthwave website, 90s web design template',
        'what' => [
            'Vaporwave is a 2010s internet art style that remixes the 80s and 90s: pastel pink and purple skies, old computer windows, marble statues, palm trees and shopping mall music.',
            'The desktop window copies classic 90s system buttons with light and dark borders. The checker floor is a repeating conic gradient tilted back, and the bust is a few rounded shapes with glowing shades.',
        ],
        'when' => ['Synth and electronic music', 'Streetwear and art drops', 'Retro gaming and nostalgia sites', 'Personal and fan pages'],
        'features' => ['Pink to purple sunset sky', 'Retro desktop window with a working playlist', 'Checker floor made with repeating-conic-gradient', 'Marble bust with glowing shades in CSS', 'Monoton and VT323 retro fonts'],
        'css' => ".floor {\n  background: repeating-conic-gradient(#fff 0 25%, #1a0933 0 50%) 0 0 / 80px 80px;\n  transform: perspective(500px) rotateX(60deg);\n}\n.win {\n  background: #c0c0c0;\n  border: 2px solid; border-color: #fff #404040 #404040 #fff;\n}\n.tb { background: linear-gradient(90deg, #000080, #1084d0); color: #fff; }",
        'faq' => [
            ['What is the vaporwave aesthetic?', 'It is a retro internet style with pastel neon colors, 90s computer graphics, Greek statues and a dreamy, ironic mood.'],
            ['How do you make a checkerboard in CSS?', 'Use repeating-conic-gradient(#fff 0 25%, #000 0 50%) with a background-size for the square size.'],
            ['How do I make a Windows 95 style button?', 'Give it a grey background and a 2px border that is light on the top and left and dark on the bottom and right. Swap them on :active.'],
        ],
    ],
    [
        'num' => 86, 'cat' => '09-cultural-aesthetic', 'slug' => '086-solarpunk', 'name' => 'Solarpunk',
        'example' => 'Sunroot, a community solar co-op',
        'title' => 'Free Solarpunk Website Template: Green and Hopeful',
        'desc' => 'Free solarpunk website template for a community solar co-op. Bright greens, a warm sun, buildings with rooftop gardens and solar panels in CSS. Live demo.',
        'keywords' => 'solarpunk website, solarpunk aesthetic, green energy website template, eco website design, sustainable brand website',
        'what' => [
        ...
        'when' => ['Clean energy and climate startups', 'Community groups and co-ops', 'Eco and sustainable brands', 'Urban farming and gardening projects'],
        'features' => ['CSS city with rooftop gardens', 'Solar panels made with a skewed striped gradient', 'Glowing sun with a soft halo', 'Big impact numbers on a green band', 'Three step how it works cards'],
        'css' => ".bld { border-radius: 18px 18px 0 0; background: var(--c); }\n.bld::before {\n  content: \"\"; position: absolute; left: -6px; right: -6px; top: -18px; height: 26px;\n  border-radius: 30px; background: #2d9d5c;\n  box-shadow: 10px -8px 0 -2px #2bb5a0, -12px -6px 0 -4px #6ccf8e;\n}\n.panel { background: repeating-linear-gradient(90deg, #1b4b8a 0 13px, #3a78c9 13px 15px); transform: skewX(-20deg); }",
        'faq' => [
            ['What is solarpunk?', 'It is an art and design movement that pictures a sustainable future with renewable energy, lots of greenery and strong communities.'],
            ['Which colors suit a solarpunk site?', 'Leaf greens, teal, sunny yellow and warm cream, with soft pinks and oranges for buildings.'],
            ['Can I use this for a real co-op?', 'Yes. Change the numbers and text, and link the share button to your sign up form.'],
        ],
    ],
    [
        'num' => 87, 'cat' => '09-cultural-aesthetic', 'slug' => '087-bauhaus', 'name' => 'Bauhaus',
        'example' => 'Weimar Workshop, a design exhibition',
        'title' => 'Free Bauhaus Website Template: Shapes and Primary Colors',
        'desc' => 'Free Bauhaus website template for a design exhibition. Red, yellow and blue, circles, squares and triangles on a strict grid poster layout. Live demo.',
        'keywords' => 'bauhaus website design, bauhaus css, primary colors design, geometric poster website, bauhaus template',
        'what' => [
        ...
        'when' => ['Exhibitions and museums', 'Design schools and studios', 'Posters and event pages', 'Architecture and furniture brands'],
        'features' => ['Poster layout built with CSS Grid', 'Circle, triangle and bar shapes in pure CSS', 'Primary red, yellow and blue palette', 'Lower case headings like classic Bauhaus type', 'Grid folds into two columns on phones'],
        ...
        'faq' => [
            ['What is Bauhaus style?', 'It is a design style from the Bauhaus school in Germany, known for primary colors, simple geometric shapes, clean type and a focus on function.'],
            ['Which font looks like Bauhaus?', 'Geometric sans serifs like Josefin Sans, Futura or Jost come close to the Bauhaus look.'],
            ['How do I make a triangle in CSS?', 'Use clip-path: polygon(50% 0, 100% 100%, 0 100%) on a block with a background color.'],
        ],
    ],
    [
        'num' => 88, 'cat' => '09-cultural-aesthetic', 'slug' => '088-art-deco', 'name' => 'Art Deco',
        'example' => 'The Gilded Lily, a cocktail bar',
        'title' => 'Free Art Deco Website Template: Gold Lines and Symmetry',
        'desc' => 'Free Art Deco website template for a cocktail bar. Gold line patterns, a sunburst fan, double frames with diamonds and symmetry on deep green. Live demo.',
        'keywords' => 'art deco website, art deco css, 1920s website design, gatsby style website, luxury bar website template',
        'what' => [
        ...
        'when' => ['Bars, restaurants and hotels', 'Weddings and events', 'Jewelry and perfume brands', 'Theaters and cinemas'],
        'features' => ['Gold sunburst fan made with conic-gradient', 'Double gold frame with diamond points', 'Vertical pinstripe background', 'Poiret One display type', 'Menu with dotted leaders to the prices'],
        ...
        'faq' => [
            ['What are the main features of Art Deco design?', 'Symmetry, geometric shapes like fans and chevrons, gold or metallic accents on rich dark colors, and tall elegant type.'],
            ['How do you make a sunburst in CSS?', 'Use a repeating conic gradient that starts at the bottom center, with thin gold slices and transparent gaps.'],
            ['Which fonts are Art Deco?', 'Poiret One, Limelight and Josefin Slab all have the tall, geometric feel of the 1920s.'],
        ],
    ],
    [
        'num' => 89, 'cat' => '09-cultural-aesthetic', 'slug' => '089-islamic-geometric', 'name' => 'Islamic Geometric',
        'example' => 'Riad Zellige, a guesthouse in Marrakech',
        'title' => 'Free Islamic Geometric Pattern Website Template (CSS)',
        'desc' => 'Free Islamic geometric pattern template for a riad in Marrakech. Eight point star tiles, pointed arches and zellige colors made with SVG and CSS. Live demo.',
        'keywords' => 'islamic geometric pattern css, moroccan website design, zellige pattern, arch shape css, riad hotel website template',
        'what' => [
        ...
        'when' => ['Riads, hotels and travel in North Africa and the Middle East', 'Restaurants and spice shops', 'Cultural centers and museums', 'Ramadan and Eid campaigns'],
        'features' => ['Eight point star tile pattern as an inline SVG', 'Pointed arch frames with border-radius', 'Gold zigzag band between sections', 'Arabic greeting with correct lang and dir', 'Room cards shaped like doorways'],
        ...
        'faq' => [
            ['How do you make an eight point star pattern?', 'Draw two squares of the same size, one rotated 45 degrees on top of the other. Repeat that tile as a background image.'],
            ['How do I make an arch shape in CSS?', 'Use border-radius with separate horizontal and vertical values on the top corners, like 50% 50% 0 0 / 36% 36% 0 0.'],
            ['How should I add Arabic text?', 'Wrap it in an element with lang="ar" and dir="rtl" and use a font that supports Arabic, such as Amiri.'],
        ],
    ],
    [
        'num' => 90, 'cat' => '09-cultural-aesthetic', 'slug' => '090-guochao', 'name' => 'Guochao',
        'example' => 'Moonrise Bakery, handmade mooncakes',
        'title' => 'Free Guochao Chinese Style Website Template (Live Demo)',
        'desc' => 'Free guochao website template for a mooncake bakery. Modern Chinese style with red and gold, ink wash mountains, cloud patterns and a seal stamp. Live demo.',
        'keywords' => 'guochao design, chinese style website template, mid autumn festival website, chinese red gold css, mooncake shop website',
        'what' => [
        ...
        'when' => ['Chinese bakeries, tea and food brands', 'Lunar New Year and Mid-Autumn campaigns', 'Chinese restaurants', 'Cultural events and brands for Chinese audiences'],
        'features' => ['Red and gold palette with jade accents', 'Big Chinese headline in Noto Serif SC', 'Ink wash mountain layers in SVG', 'Cloud pattern and vertical seal stamp', 'Mooncake product cards with double gold frames'],
        'css' => ":root { --red: #b3211e; --deep: #7c1512; --gold: #e0b25b; --paper: #f7efe0; }\n.zh { font-family: \"Noto Serif SC\", serif; font-weight: 900; color: var(--gold); letter-spacing: .08em; }\n.moon { border-radius: 50%;\n  background: radial-gradient(circle at 40% 35%, #fff4d0, #f1c979 60%, #d9a24b);\n  box-shadow: 0 0 80px rgba(240, 200, 120, .5); }\n.seal { writing-mode: vertical-rl; background: var(--red); outline: 2px solid var(--red); }",
        'faq' => [
            ['What is guochao style?', 'Guochao is a Chinese design trend that mixes traditional Chinese culture, such as red and gold, calligraphy, clouds and landscapes, with modern fashion and layout.'],
            ['Which fonts work for Chinese websites?', 'Noto Serif SC and Noto Sans SC are free, cover simplified Chinese and look good at every size.'],
            ['Can I use this for Lunar New Year?', 'Yes. Swap the moon for lanterns or the zodiac animal, and change the headline and products.'],
        ],
    ],
